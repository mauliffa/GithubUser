...
class AlarmReceiver : BroadcastReceiver() {
    ...
    fun setRepeatingAlarm(context: Context, message: String) {
        val statusOn = context.getString(R.string.alarm_on)
        ...
        Toast.makeText(context, statusOn, Toast.LENGTH_SHORT).show()
    }
    ...
    fun cancelAlarm(context: Context) {
        val statusOff = context.getString(R.string.alarm_off)
        val alarmManager = context.getSystemService(Context.ALARM_SERVICE) as AlarmManager
        val intent = Intent(context, AlarmReceiver::class.java)
        ...
        Toast.makeText(context, statusOff, Toast.LENGTH_SHORT).show()
    }
}
